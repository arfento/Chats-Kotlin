package com.ims.chats_kotlin.data.db.remote
...
class FirebaseAuthSource {
    ...
    private fun attachAuthObserver(b: ((com.ims.chats_kotlin.data.Result<FirebaseUser>) -> Unit)): FirebaseAuth.AuthStateListener {
